...
class Config:
    ...
    MONDAY_WORKSPACE_SUBDOMAIN = os.environ.get('MONDAY_WORKSPACE_SUBDOMAIN', '')
    
    # Board Display Names
    DEALS_BOARD_NAME = os.environ.get('DEALS_BOARD_NAME', 'Deals')
    WORK_ORDERS_BOARD_NAME = os.environ.get('WORK_ORDERS_BOARD_NAME', 'Work Orders')
